use crate::core::data_structures::graphs::{WeightedGraph, graph_base::GraphBase, weighted::Weight};
...
mod tests {
    ...
    use super::*;
    use crate::core::data_structures::graphs::UndirectedWeightedGraph;
    ...
    fn test_dijkstra_algorithm() {
        ...
        graph.add_weighted_edge(1, 2, EdgeData::from(10.0));
        graph.add_weighted_edge(1, 3, EdgeData::from(5.0));
        graph.add_weighted_edge(2, 3, EdgeData::from(2.0));
        graph.add_weighted_edge(1, 4, EdgeData::from(10.0));
    ...
    fn test_dijkstra_path_basic() {
        ...
        graph.add_weighted_edge(1, 2, EdgeData::from(10.0));
        graph.add_weighted_edge(1, 3, EdgeData::from(5.0));
        graph.add_weighted_edge(3, 2, EdgeData::from(2.0));
        graph.add_weighted_edge(1, 4, EdgeData::from(10.0));
