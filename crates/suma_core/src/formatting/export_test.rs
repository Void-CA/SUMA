...
mod tests {
    use serde::Serialize;
    use crate::formatting::export::Exportable;
...
mod export_hierarchical_tests {use std::collections::HashMap;
    ...
    use crate::formatting::export::Exportable;
    use crate::formatting::utils::build_markdown_table;
    ...
    fn test_separate_fields() {
        ...
        let (flat, nested) = crate::formatting::utils::separate_fields(&obj);
    ...
    fn test_get_unique_headers() {
        ...
        let headers = crate::formatting::utils::get_unique_headers(&data);
    ...
    fn test_value_to_string_readable() {
        // String
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::String("hello".to_string())),
            "hello"
        );

        // Number
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::Number(42.into())),
            "42"
        );

        // Boolean
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::Bool(true)),
            "true"
        );

        // Null
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::Null),
            "null"
        );

        // Array simple
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::Array(vec![
                Value::Number(1.into()),
                Value::Number(2.into()),
            ])),
            "[1, 2]"
        ...
        // Object
        assert_eq!(
            crate::formatting::utils::value_to_string_readable(&Value::Object(Map::new())),
            "{...}"
        );
    }
