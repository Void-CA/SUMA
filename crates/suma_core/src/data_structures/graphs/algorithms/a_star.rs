...
mod tests {
    ...
    fn setup_graph_int() -> (UndirectedWeightedGraph<&'static str, i32>, Vec<usize>) {
        ...
        graph.add_edge_id(n0, n1, 1);
        graph.add_edge_id(n1, n2, 2);
        graph.add_edge_id(n0, n2, 4);
        graph.add_edge_id(n2, n3, 1);
    ...
    fn setup_graph_float() -> (UndirectedWeightedGraph<&'static str, OrderedFloat<f64>>, Vec<usize>) {
        ...
        graph.add_edge_id(n0, n1, OrderedFloat(1.0));
        graph.add_edge_id(n1, n2, OrderedFloat(2.0));
        graph.add_edge_id(n0, n2, OrderedFloat(4.0));
        graph.add_edge_id(n2, n3, OrderedFloat(1.0));
...
struct Point {
    ...
    fn setup_graph_point() -> (UndirectedWeightedGraph<Point, OrderedFloat<f64>>, Vec<usize>) {
        ...
        graph.add_edge_id(n0, n1, OrderedFloat(1.5));
        graph.add_edge_id(n1, n2, OrderedFloat(2.5));
        graph.add_edge_id(n0, n2, OrderedFloat(5.0));
        graph.add_edge_id(n2, n3, OrderedFloat(1.0));
