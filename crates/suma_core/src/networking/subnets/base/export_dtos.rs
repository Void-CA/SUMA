...
use crate::networking::subnets::base::{SubnetRow, BaseCalculator};
...
mod tests {
    ...
    use super::*;
    use crate::networking::subnets::flsm::FLSMCalculator;
    use serde_json;

    #[test]
    fn test_subnet_export_from_subnet_row() {
        // Crear un SubnetRow de prueba
        let row = crate::networking::subnets::base::SubnetRow {
            subred: 1,
